...
describe('Transaction', () => {
  ...
  describe('outputMap', () => {
    ...
    it('outputs the remaining balace for the `senderWallet`', () => {
  ...
  describe('input', () => {
    ...
    it('signs the input', () => {
      const verificationSignatureResult = verifySignature({
        publicKey: transaction.input.address,
        data: transaction.outputMap,
        signature: transaction.input.signature
      });

      expect(verificationSignatureResult).toBe(true);
    });
  });
    ...
    describe('when the transaction is invalid', () => {
      describe('and a transaction outputMap is invalid', () => {
        it('returns false and logs an error', () => {
          transaction.outputMap[senderWallet.publicKey] = 'fake-public-key';
  ...
  describe('update()', () => {
    ...
    describe('and the amount is invalid', () => {
      it('throws an error', () => {
        expect(() => transaction.update({ senderWallet, recipient: 'foo-recipient', amount: 999999 }))
    ...
    describe('and the amount is valid', () => {
      ...
      it('maintains a total output that matches the input amount', () => {
        const totalOutput = Object.values(transaction.outputMap).reduce((total, output) => total + output);
